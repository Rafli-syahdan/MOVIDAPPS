package com.prjctbyrafli.movid
...
import com.prjctbyrafli.movid.checkout.ChooseSeatActivity
import com.prjctbyrafli.movid.home.dashboard.PlaysAdapter
import com.prjctbyrafli.movid.model.Film
import com.prjctbyrafli.movid.model.Plays
...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_pilih_bangku.setOnClickListener {
             var intent = Intent(this@DetailActivity, ChooseSeatActivity::class.java)
                 .putExtra("data", data)
